...
public class BottomBarTab extends LinearLayout {
    ...
    BottomBarTab(Context context) {
        ...
        sixDps = UiUtil.dpToPixel(context, 6);
        eightDps = UiUtil.dpToPixel(context, 8);
        sixteenDps = UiUtil.dpToPixel(context, 16);
    }
    ...
    public int getSelectIconResId() {
        return selectIconResId;
    }

    public void setSelectIconResId(int selectIconResId) {
    ...
    void select(boolean animate) {
        isActive = true;
        iconView.setImageResource(selectIconResId);
        if (animate) {
