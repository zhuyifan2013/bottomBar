...
class BottomNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    private final BottomNavigationWithSnackbar mWithSnackBarImpl = Build.VERSION.SDK_INT >= Build
            .VERSION_CODES.LOLLIPOP ? new LollipopBottomNavWithSnackBarImpl() : new
            PreLollipopBottomNavWithSnackBarImpl();
